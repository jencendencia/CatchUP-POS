...
interface ExpenseDao {
    ...
    @RawQuery
    suspend fun getTotalExpensesByDateRangeRaw(query: SupportSQLiteQuery): Double?

    @RawQuery
    suspend fun getExpenseCategoryTotalsRaw(query: SupportSQLiteQuery): ExpenseCategoryTotals?
